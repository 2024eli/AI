...
def playGame(quickMove, token, show=False):
  ...
  while True:
    ...
    brd = makeMoves(brd, tknToPlay, mv)  # , moves
...
try:
  _tmp = __import__(defFile, globals=None, locals=None,
                    fromlist=['quickMove', 'findMoves', 'makeMoves'], level=0)
  quickMove, findMoves, makeMoves = _tmp.quickMove, _tmp.findMoves, _tmp.makeMoves
except:
