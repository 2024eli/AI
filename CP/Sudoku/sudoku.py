...
def setGlobals(pzl):
  ...
  # if pzl == '.GD.E..BI......NH...O..ME......A...CD.J.B..IM.NFCL.........JI.G.B...N.D.MC.A.E..JM...N.IG.E.K....JGI.D.AH.O..F.....L..J.LI.A.DBM....E.K.EJ.C...LK..G.N.LN.G.F...I.D.OB.........HKCF.KB..A.J.CN...O......AL..D...KC......IO..J.AM.' or pzl =='6....B..8..7..85.1...2..12....86.AC........B2.6.3..8...95.BC.91.2.3..........5.7.39.C4.39...7..B.1.9B........83.AC....52..A...7.C4..2..4..1....A':
  #   print(miniW, miniH)
  #   print(rowcs)
  #   print(colcs)
  #   print(subcs)
...
if __name__ == '__main__':
  ...
  for pzl in f:
    pz = pzl.strip('\n')
    if beforePzNum != len(pzl):
      setGlobals(pz)
      beforePzNum = len(pzl)
      updateStats("run setGlobals")
